...
!function(modules) {
    ...
    375: function(module, exports, __webpack_require__) {
        ...
        const src_1 = __webpack_require__(1), ContentEvents_1 = __webpack_require__(13), IframeEvents_1 = __webpack_require__(157), UrlsSafeCheckEvents_1 = __webpack_require__(41), GoogleAnalyticsContentDispatcher_1 = __webpack_require__(95), dispatcher = new src_1.ContentDispatcherService, googleAnalytics = new GoogleAnalyticsContentDispatcher_1.GoogleAnalyticsContentDispatcher(dispatcher);
        let muteCheckboxEl, btnContinueEl, btnLeaveEl;
        document.addEventListener("DOMContentLoaded", () => {
            muteCheckboxEl = document.getElementById("muteCheckbox"), btnContinueEl = document.getElementById("btnContinue"), 
            btnLeaveEl = document.getElementById("btnLeave"), btnContinueEl.addEventListener("click", () => {
                !function() {
                    try {
                    ...
                    }(IframeEvents_1.IframeEvents.CLOSE);
                }();
